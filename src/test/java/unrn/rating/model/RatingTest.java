...
public class RatingTest {
    ...
    void valor_fuera_de_rango_lanza_excepcion() {
        var ex = assertThrows(RuntimeException.class, () -> Rating.crear(1L, "user1", 11, null, null));
    ...
    void comentario_vacio_informa_lanza_excepcion() {
        var ex = assertThrows(RuntimeException.class, () -> Rating.crear(1L, "user1", 5, "   ", null));
    ...
    void pelicula_nula_lanza_excepcion() {
        var ex = assertThrows(RuntimeException.class, () -> Rating.crear(null, "user1", 5, null, null));
    ...
    void usuario_nulo_lanza_excepcion() {
        var ex = assertThrows(RuntimeException.class, () -> Rating.crear(1L, null, 5, null, null));
