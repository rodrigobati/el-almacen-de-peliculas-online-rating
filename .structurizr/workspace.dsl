workspace "Rating - El Almacén de Películas Online" "Vertical de gestión de ratings y comentarios de películas" {
    ...
    model {
        ...
        securityConfig -> keycloak "Obtiene clave pública para validar JWT"
        ...
        messagingConfig -> rabbitmq "Publica RatingActualizadoEvent (CREATE, UPDATE)"
    ...
    views {
        !define RELATIONSHIP_FONT_SIZE 24
        ...
        component ratingVertical.apiRest {
            ...
            component ratingController "RatingController" "Expone endpoints REST: POST /api/ratings, GET /api/ratings/pelicula/{id}, etc." "Spring REST Controller" "ControllerComponent"
            component ratingMapper "RatingMapper" "Mapea entre DTOs y entidades del dominio" "Mapper Utility" "MapperComponent"
            component requestDto "RatingRequestDto" "DTO para solicitudes HTTP: peliculaId, valor, comentario" "Data Transfer Object" "DTOComponent"
            component responseDto "RatingResponseDto" "DTO para respuestas HTTP: id, usuario, puntaje, comentario, fechaCreacion" "Data Transfer Object" "DTOComponent"
        ...
        component ratingVertical.appService {
            ...
            component ratingService "RatingService" "Orquesta la creación, actualización y consulta de ratings. Publica eventos asincronos." "Spring Service" "ServiceComponent"
            component keycloakUserService "KeycloakUserService" "Integración con Keycloak para obtener usernames y validación de usuarios" "Service" "ExternalServiceComponent"
            component duplicateRatingException "DuplicateRatingException" "Excepción personalizada para validar ratings únicos por usuario-película" "Custom Exception" "ExceptionComponent"
        ...
        component ratingVertical.domain {
            ...
            component rating "Rating (Entidad)" "Representa una calificación de película: peliculaId, usuarioId, puntaje, comentario, timestamp. Encapsula validaciones." "JPA Entity" "EntityComponent"
            component puntaje "Puntaje (Value Object)" "Representa el valor numérico del rating (1-10). Encapsula validaciones de rango." "JPA Embeddable" "ValueObjectComponent"
            component comentario "Comentario (Value Object)" "Texto del comentario asociado al rating. Validaciones de no vacío." "JPA Embeddable" "ValueObjectComponent"
            component peliculaId "PeliculaId (Value Object)" "Identificador único de película. Encapsula tipo y validaciones." "Value Object" "ValueObjectComponent"
            component usuarioId "UsuarioId (Value Object)" "Identificador único de usuario de Keycloak. Encapsula tipo y validaciones." "Value Object" "ValueObjectComponent"
        ...
        component ratingVertical.repository {
            ...
            component ratingRepository "RatingRepository" "Spring Data JPA Repository. Define queries personalizadas: existsByPeliculaIdAndUsuarioId, findByPeliculaId, countByPeliculaId" "Spring Data JPA" "RepositoryComponent"
        ...
        component ratingVertical.securityConfig {
            ...
            component securityConfiguration "SecurityConfiguration" "Configura filtros de seguridad, validación de JWT OAuth2 y control de acceso basado en roles" "Spring Security Config" "SecurityComponent"
            component jwtConverter "KeycloakGrantedAuthoritiesConverter" "Convierte claims del JWT de Keycloak a autoridades de Spring Security" "JWT Converter" "SecurityComponent"
        ...
        component ratingVertical.messagingConfig {
            ...
            component rabbitConfig "RabbitMQConfig" "Define exchanges (topic), colas y configuración de JSON converter para serialización" "Spring AMQP Config" "MessagingComponent"
            component messagePublisher "MessagePublisher" "Publica eventos RatingActualizadoEvent en el exchange de RabbitMQ" "Message Publisher" "MessagingComponent"
            component ratingActualizadoEvent "RatingActualizadoEvent" "Evento de dominio: peliculaId, promedio, totalRatings. Routing key: RatingActualizadoEvent.CREATE" "Event DTO" "EventComponent"
            component messageListener "MessageListener" "Placeholder para consumir eventos (actualmente deshabilitado)" "Message Listener" "MessagingComponent"
        ...
        dynamic ratingVertical {
            ...
            ratingVertical.apiRest -> ratingVertical.securityConfig "4. Valida JWT"
            ratingVertical.securityConfig -> keycloak "5. Obtiene clave pública"
            ratingVertical.apiRest -> ratingVertical.appService "6. Procesa rating"
            ratingVertical.appService -> ratingVertical.domain "7. Crea entidad Rating"
            ratingVertical.appService -> ratingVertical.repository "8. Persiste en BD"
            ratingVertical.appService -> ratingVertical.messagingConfig "9. Publica evento"
            ratingVertical.messagingConfig -> rabbitmq "10. Envía RatingActualizadoEvent"
            rabbitmq -> catalogoService "11. Consume evento"
            ratingVertical.apiRest -> frontend "12. Retorna 201 CREATED"
            frontend -> usuario "13. Muestra confirmación"
        }
